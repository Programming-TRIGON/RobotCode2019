...
public class DifferentialTankDrivetrain extends TankDrivetrain{
    ...
    public void arcadeDrive(double movement, double rotation){
        arcadeDrive(movement, rotation, CURVATURE_THRESHOLD);
    }

    public void arcadeDrive(double movement, double rotation, double threshold){
        differentialDrive.curvatureDrive(movement, rotation, movement <= threshold);
    }
}
