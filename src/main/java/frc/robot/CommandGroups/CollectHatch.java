...
public class CollectHatch extends CommandGroup {
    ...
    public CollectHatch() {
        ...
        addParallel(new SetLiftHeight(RobotConstants.LiftHeight.kHatchCollection));
        addParallel(new SetOneEightyAngle(RobotStates.isDriveInverted() ? RobotConstants.OneEightyAngle.kStraight
                : RobotConstants.OneEightyAngle.kBack));
