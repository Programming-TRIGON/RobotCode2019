...
public class RobotMap {
   ...
   static class CAN {
    ...
    static class PCM0 {
        ...
        public static final int HATCH_HOLDER_PVC_SOLENOID_B = 0;//6;

        public static final int HATCH_HOLDER_PUSH_SOLENOID_A = 3;
        public static final int HATCH_HOLDER_PUSH_SOLENOID_B = 1;

        public static final int CARGO_FOLDER_SOLENOID_A = 2; //3 Checked
        public static final int CARGO_FOLDER_SOLENOID_B = 5; //6 Checked
