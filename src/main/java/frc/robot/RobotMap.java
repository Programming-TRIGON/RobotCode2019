...
public class RobotMap {
   ...
   static class CAN {
    ...
    static class PCM0 {
        // as of 12/2/19 02:20
        public static final int HATCH_COLLECTOR_SOLENOID_A = 5;
        public static final int HATCH_COLLECTOR_SOLENOID_B = 2;

        public static final int HATCH_HOLDER_PVC_SOLENOID_A = 6;
        public static final int HATCH_HOLDER_PVC_SOLENOID_B = 1;

        public static final int HATCH_HOLDER_PUSH_SOLENOID_A = 0;
        public static final int HATCH_HOLDER_PUSH_SOLENOID_B = 7;

        public static final int CARGO_FOLDER_SOLENOID_A = 3;
        public static final int CARGO_FOLDER_SOLENOID_B = 4;
