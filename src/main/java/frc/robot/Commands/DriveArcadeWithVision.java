...
public class DriveArcadeWithVision extends DriveArcadeWithPID {
  ...
  public DriveArcadeWithVision(TankDrivetrain drivetrain, VisionPIDSource visionPIDSource, Supplier<Double> setpointSupplier,
      Supplier<Double> movementSupplier, PIDSettings PIDSettings, double inputRange, boolean continuous) {
    super(drivetrain, visionPIDSource, setpointSupplier, movementSupplier, () -> false, PIDSettings, inputRange, continuous);
  }

  public DriveArcadeWithVision(TankDrivetrain drivetrain, VisionPIDSource visionPIDSource, double setpoint, double movement,
